...
moreButton.addEventListener('click', ()=> {
    ...
    <fieldset>
            ...
            <label>
                in package
                <input name="inPackage" type="number" required min="0" step="any"/>
            </label>
            <label>
                cost of package
                <input name="costOfPackage" type="number" required min="0" step="any"/>
            </label>
            <label>
                in receipt
                <input name="inReceipt" type="number" required min="0" step="any"/>
            </label>
...
countButton.addEventListener('click', (evt) => { evt.preventDefault();
    if(document.querySelector("form").reportValidity() === true) {
        ...
        <label class="total-count">
            ...
            <input id="totalNumber" type="number" min="0" step="any"/>
